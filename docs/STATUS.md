...
> Última actualización: 2026-02-25 | Iteración: 5

## Estado actual: WAVE 5 — Documentos + RAG (completada)
...
- [x] Build exitoso (`npm run build` — 18 rutas)
...
- [x] **DB Schema**: tenants, profiles, municipios, convocatorias, mga_templates, convocatoria_municipios, submissions, audit_logs, documents, embeddings
- [x] **RLS Policies**: aislamiento completo (10 tablas con policies)
