...
> Última actualización: 2026-02-25 | Iteración: 4

## Estado actual: WAVE 4 — Asistente IA (completada)
...
- [x] Build exitoso (`npm run build` — 16 rutas)
...
- [x] **DB Schema**: tenants, profiles, municipios, convocatorias, mga_templates, convocatoria_municipios, submissions, audit_logs
- [x] **RLS Policies**: aislamiento completo (8 tablas con policies)
...
- [x] **Prompt contextual**: system prompt MGA + user prompt con convocatoria/etapa/campo
...
- [x] **Panel respuesta IA**: muestra suggested_text, bullets, risks, missing_info_questions
...
### Rutas disponibles (16 total)
| Ruta | Acceso | Descripción |
|------|--------|-------------|
| `/` | Público | Redirect |
| `/login` | No auth | Login + signup |
| `/auth/callback` | Sistema | Callback OAuth |
| `/api/ai/assist` | Auth (POST) | Endpoint asistente IA |
