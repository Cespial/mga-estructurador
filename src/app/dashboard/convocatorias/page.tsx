  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-[22px] font-semibold tracking-tight text-text-primary">Convocatorias</h1>
              ...
              <Link key={conv.id} href={`/dashboard/convocatorias/${conv.id}`}>
                <Card variant="interactive" padding="none" className="h-full">
                  <div className="px-6 pt-5 pb-4">
                    ...
                    {conv.description && (
                      <p className="mt-2 text-[13px] text-text-muted line-clamp-2">{conv.description}</p>
                    )}
                  </div>
                  ...
                  <div className="divide-y divide-border">
                    {/* Budget */}
                    {conv.budget && (
                      <div className="flex items-center gap-2.5 px-6 py-3 text-[13px]">
